...
# fzf - fuzzy finder keybindings (Ctrl-T files, Alt-C cd dir) + completion.
# Sourced BEFORE atuin so atuin keeps ownership of Ctrl-R (fzf would otherwise
# rebind it to its own history widget).
